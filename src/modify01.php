<?php
    ...
    else                                             
    {
        ...
        if(is_null($arr_info["com_flg"]))                                                           // 체크 해제하고 update 시 $arr_flg['com_flg'] 값이 null값이 되는데 
        {                                                                                           // 체크 해제하고 update 시 $arr_flg['com_flg'] 값이 null값이 되는데 
            $arr_info["com_flg"] = "0";                                                             // com_flg는 데이터베이스에서 제약조건이 not null 이라                                                          
