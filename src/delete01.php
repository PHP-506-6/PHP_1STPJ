...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="css/delete01.css">
    </head>
    <body>
        ...
        <div class="container" >
            <form method="POST" action="delete01.php">
                ...
                <div class="form_box2">
                    ...
                    <input type="text" name="ex_set" maxlength="2" id="ex_set" value="<?php echo $result_info['ex_set'] ?>" readonly>
                    <span class="set_box">SET</span>
                    
                    <label class="box2_tit" for="ex_num">횟수</label>
                    <input type="text" name="ex_num" maxlength="3" id="ex_num" value="<?php echo $result_info['ex_num'] ?>" readonly>
                    <span class="num_box" >회</span>
                    
                    <span  class="time_lab box2_tit">시간</span>
                    <input class="time" type="text" name="ex_hour" maxlength="1" id="ex_hour" value="<?php echo $result_info['ex_hour'] ?>" readonly>
                    <label for="ex_hour">시간</label>
                    
                    <input class="time" type="text" name="ex_min" maxlength="2" id="ex_min" value="<?php echo $result_info['ex_min'] ?>" readonly>
                    <label  for="ex_min">분</label>
            
                    <label for="com_flg" class="box2_tit" >완료 여부</label>
                    <input class="complete" type="text" name="com_flg" value="<?php echo $str_com_flg ?>
                    " readonly> 
                </div>
                <p class="alert">정보를 모두 삭제합니다.<br>동의 하시면 확인을 눌러 주세요.</p>
                <div class="del_btn">
                    <button type ="submit">확인</button>
                    <a class="link_btn" href="list.php">취소</a>                   
                </div>
        </form>
    </div>
</body>
